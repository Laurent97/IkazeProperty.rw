    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600">Manage property visit requests and connect customers with sellers</p>
        </div>
        <Button
          ...
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{getCompletedVisits()}</p>
              </div>
            </div>
          </CardContent>
        </Card>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b">
                  ...
                  <th className="text-left py-3 px-4 font-semibold text-gray-900 text-sm">Seller/Agent</th>
                  <th className="text-left py-3 px-4 font-semibold text-gray-900 text-sm">Visit Fee</th>
          ...
          <Card className="w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-semibold">Visit Request Details</h3>
                <button
              ...
              <div className="mt-6 space-y-4">
                ...
                <div className="bg-yellow-50 rounded-lg p-4">
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <div>
                      <div className="text-sm text-yellow-700">Platform Fee</div>
                      <div className="text-lg font-bold text-yellow-900">
                        RWF {selectedRequest.platform_fee.toLocaleString()}
                      </div>
                    </div>
                    <div>
                      <div className="text-sm text-yellow-700">Seller Payout</div>
                      <div className="text-lg font-bold text-yellow-900">
                  ...
                  <div className="mt-4 pt-4 border-t border-yellow-200">
                    <div className="text-sm text-yellow-700">
                      <strong>Payment Reference:</strong> {selectedRequest.payment_reference}
                    </div>
                    <div className="text-sm text-yellow-700">
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                ...
                {selectedRequest.status === 'paid' && (
                  <Button 
                    onClick={() => {
                      updateRequestStatus(selectedRequest.id, 'released')
                      setShowDetailsModal(false)
                    }}
