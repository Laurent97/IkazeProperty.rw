                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm">Year: {listing.car_details.year_manufacture}</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Fuel className="h-4 w-4 text-gray-500" />
                        <span className="text-sm">Fuel: {listing.car_details.fuel_type}</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Settings className="h-4 w-4 text-gray-500" />
                        <span className="text-sm">Transmission: {listing.car_details.transmission}</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Gauge className="h-4 w-4 text-gray-500" />
                        <span className="text-sm">Mileage: {listing.car_details.mileage.toLocaleString()} km</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <span className="text-sm">Engine: {listing.car_details.engine_capacity} cc</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <span className="text-sm">Color: {listing.car_details.color}</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <span className="text-sm">Doors: {listing.car_details.doors}</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <span className="text-sm">Seats: {listing.car_details.seats}</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <span className="text-sm">Condition: {listing.car_details.condition}</span>
                      </div>
                    </div>
