                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm">{listing.house_details.property_type}</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Bed className="h-4 w-4 text-gray-500" />
                        <span className="text-sm">{listing.house_details.bedrooms} bedrooms</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Bath className="h-4 w-4 text-gray-500" />
                        <span className="text-sm">{listing.house_details.bathrooms} bathrooms</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Square className="h-4 w-4 text-gray-500" />
                        <span className="text-sm">{listing.house_details.total_area} m²</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Car className="h-4 w-4 text-gray-500" />
                        <span className="text-sm">{listing.house_details.parking}</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <span className="text-sm">Condition:</span>
                        <span className="text-sm">{listing.house_details.condition}</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <span className="text-sm">Furnished:</span>
                        <span className="text-sm">{listing.house_details.furnished}</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <span className="text-sm">Year Built:</span>
                        <span className="text-sm">{listing.house_details.year_built}</span>
                      </div>
                    </div>
