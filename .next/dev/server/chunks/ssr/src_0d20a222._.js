...
"[project]/src/app/[locale]/dashboard/admin/listings/[id]/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdminListingDetailPage() {
    ...
    const fetchListingDetails = async ()=>{
        try {
            ...
            const { data: listingData, error: listingError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('listings').select(`
          *,
        ...
        `).eq('id', listingId).single();
            ...
            const { data: inquiriesData, error: inquiriesError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('inquiries').select(`
          *,
    ...
    const handleUpdateListing = async ()=>{
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('listings').update(formData).eq('id', listingId);
    ...
    const handleDeleteListing = async ()=>{
        ...
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('listings').delete().eq('id', listingId);
            if (error) throw error;
    ...
    const handleStatusChange = async (newStatus)=>{
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('listings').update({
                status: newStatus
            }).eq('id', listingId);
            if (error) throw error;
            setListing({
...
//# sourceMappingURL=src_0d20a222._.js.map