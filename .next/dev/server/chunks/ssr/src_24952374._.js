...
"[project]/src/app/[locale]/dashboard/admin/transactions/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdminTransactionsPage() {
    ...
    const fetchTransactions = async ()=>{
        try {
            setLoading(true);
            let query = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('transactions').select(`
          *,
    ...
    const fetchStats = async ()=>{
        try {
            ...
            const [totalRevenueResult, completedCountResult, pendingCountResult, thisMonthRevenueResult] = await Promise.all([
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('transactions').select('commission_amount').eq('status', 'completed').like('created_at', `${currentMonth}%`)
            ]);
    ...
    const handleUpdateStatus = async (transactionId, newStatus)=>{
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('transactions').update({
                status: newStatus
            }).eq('id', transactionId);
            if (error) throw error;
...
//# sourceMappingURL=src_24952374._.js.map