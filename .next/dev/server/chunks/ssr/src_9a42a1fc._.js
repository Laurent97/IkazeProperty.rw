    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const checkFavoriteStatus = async ()=>{
            try {
                ...
                const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('favorite_listings').select('*').eq('user_id', currentUser.id).eq('listing_id', listingId).single();
    ...
    const toggleFavorite = async ()=>{
        ...
        try {
            if (isFavorited) {
                ...
                const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('favorite_listings').delete().eq('user_id', user.id).eq('listing_id', listingId);
                if (error) throw error;
                setIsFavorited(false);
                // Update the likes count on the listing using SQL
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].rpc('sql', {
                    sql: `SELECT decrement_likes('${listingId}')`
                });
            } else {
                // Add to favorites
                const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('favorite_listings').insert({
                    user_id: user.id,
...
//# sourceMappingURL=src_9a42a1fc._.js.map