module.exports = [
"[project]/src/app/[locale]/dashboard/my-listings/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function MyListingsPage() {
    ...
    const fetchListings = async ()=>{
        try {
            ...
            setUser(currentUser);
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('listings').select('*').eq('seller_id', currentUser.id).order(sortBy, {
                ascending: false
            });
    ...
    const deleteListing = async (id)=>{
        ...
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('listings').delete().eq('id', id);
            if (error) throw error;
...
//# sourceMappingURL=_a7bec587._.js.map