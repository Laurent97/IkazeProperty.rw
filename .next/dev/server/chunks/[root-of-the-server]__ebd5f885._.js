...
async function POST(request) {
    try {
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('settings').upsert({
            id: 1,
            ...body,
            updated_at: new Date().toISOString()
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ebd5f885._.js.map