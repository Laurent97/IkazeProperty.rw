...
"[project]/src/app/api/ads/analytics/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('ad_analytics').insert({
        ...
        const { data: currentCampaign } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('ad_campaigns').select(updateField).eq('id', campaignId).single();
        if (currentCampaign) {
            const currentValue = currentCampaign[updateField] || 0;
            const { error: updateError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('ad_campaigns').update({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7ab479cd._.js.map