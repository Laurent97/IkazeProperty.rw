...
async function GET() {
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('site_settings').select('admin_phone, whatsapp_phone, support_email, office_address').order('updated_at', {
            ascending: false
        }).limit(1).single();
        if (error || !data) {
