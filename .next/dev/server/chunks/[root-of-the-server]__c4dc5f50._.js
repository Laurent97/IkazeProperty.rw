...
async function POST(request) {
    try {
        ...
        const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(("TURBOPACK compile-time value", "https://swshkufpktnacbotddpb.supabase.co"), process.env.SUPABASE_SERVICE_ROLE_KEY);
        ...
        const { listing_id, payment_method, phone_number, crypto_type } = body;
        ...
        const { data: listing, error: listingError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('listings').select('id, seller_id, visit_fee_enabled, visit_fee_amount').eq('id', listing_id).single();
        ...
        if (!listing.visit_fee_enabled) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Visit fee is disabled for this listing'
            }, {
                status: 400
            });
        }
        ...
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$payment$2f$factory$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PaymentProcessorFactory"].initiatePayment(paymentRequest);
        if (!result.success) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const { data: transaction } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('payment_transactions').select('id').eq('our_reference', result.reference).single();
        const { data: visitRequest, error: visitError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('visit_requests').insert({
            listing_id: listing.id,
            buyer_id: user.id,
        ...
        if (visitError) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: visitError.message || 'Failed to create visit request'
            }, {
                status: 500
            });
        }
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: error.message || 'Failed to request visit'
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c4dc5f50._.js.map