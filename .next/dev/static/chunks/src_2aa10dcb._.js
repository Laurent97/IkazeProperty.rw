...
function RegisterPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signUp"])(formData.email, formData.password, formData.fullName);
            setSuccess(true);
        } catch (err) {
...
_s(RegisterPage, "5zQrZrYtuAkFNxzfIsdCQ5JCl1Y=", false, function() {
    return [
...
//# sourceMappingURL=src_2aa10dcb._.js.map