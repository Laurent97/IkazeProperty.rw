...
function AdminAdManagementPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminAdManagementPage.useEffect": ()=>{
            ...
            const mockCampaigns = [
                {
                    id: '1',
                    title: 'Featured Apartment Listing - John Doe',
                    user_id: 'user1',
                ...
                {
                    id: '2',
                    title: 'Homepage Banner - Tech Corp',
                    user_id: 'user2',
                    user_email: 'marketing@techcorp.com',
                    user_name: 'Tech Corp',
                    status: 'pending',
                    ad_type: 'banner',
                    impressions: 0,
                ...
                {
                    id: '3',
                    title: 'Social Media Boost - Sarah Smith',
                    user_id: 'user3',
                    ...
                    rejection_reason: 'Inappropriate content - violates community guidelines'
                }
            ];
            setTimeout({
                "AdminAdManagementPage.useEffect": ()=>{
            ...
            }["AdminAdManagementPage.useEffect"], 1000);
        }
    }["AdminAdManagementPage.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminAdManagementPage.useEffect": ()=>{
            ...
            if (searchQuery) {
                filtered = filtered.filter({
                    "AdminAdManagementPage.useEffect": (campaign)=>campaign.title.toLowerCase().includes(searchQuery.toLowerCase()) || campaign.user_name.toLowerCase().includes(searchQuery.toLowerCase()) || campaign.user_email.toLowerCase().includes(searchQuery.toLowerCase())
                }["AdminAdManagementPage.useEffect"]);
            }
    ...
    const handleApprove = async (campaignId)=>{
        // In real app, call API to approve campaign
    ...
    const handleReject = async (campaignId, reason)=>{
        // In real app, call API to reject campaign
        setCampaigns((prev)=>prev.map((c)=>c.id === campaignId ? {
                    ...c,
                    status: 'rejected',
    ...
    const handleCreateAd = async ()=>{
        ...
        try {
            // Save to database
            const { data: campaign, error } = await supabaseAdmin.from('ad_campaigns').insert({
                title: newAd.title,
                ad_type: newAd.ad_type,
                placement_code: 'homepage_leaderboard',
                status: 'draft',
                budget_total: newAd.budget_total,
                start_date: newAd.start_date,
                end_date: newAd.end_date,
                landing_page: newAd.landing_page,
                target_audience: newAd.target_audience,
                advertiser_name: newAd.user_name,
                advertiser_email: newAd.user_email,
            ...
            // Save creative if uploaded
            if (newAd.creative_url) {
                await supabaseAdmin.from('ad_creatives').insert({
                    campaign_id: campaign.id,
                    url: newAd.creative_url,
                    media_type: 'image',
                    order_index: 0,
                    is_primary: true
                });
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                ...
                                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    children: [
                                                                        ...
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                            className: "text-xs sm:text-sm text-gray-600 truncate max-w-[120px] sm:max-w-none",
                                                                            children: campaign.user_email
                                                                        }, void 0, false, {
                                                                            fileName: "[project]/src/app/[locale]/admin/ads/page.tsx",
                                                                            lineNumber: 465,
                                                                            columnNumber: 27
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                children: [
                                                                    ...
                                                                    " ",
                                                                    selectedCampaign.ad_type.replace('_', ' ')
                                                                ]
                                                            }, void 0, true, {
                                                                fileName: "[project]/src/app/[locale]/admin/ads/page.tsx",
                                                                lineNumber: 774,
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h4", {
                                                        className: "font-semibold text-gray-900 mb-2",
                                                        children: "Advertiser Information"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/[locale]/admin/ads/page.tsx",
                                                        lineNumber: 805,
                                                        columnNumber: 21
...
//# sourceMappingURL=src_app_%5Blocale%5D_admin_ads_page_tsx_56b2e859._.js.map