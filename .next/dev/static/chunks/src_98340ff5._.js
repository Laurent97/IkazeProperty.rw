...
const uploadImage = async (file, options = {})=>{
    try {
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cloudinary$2f$cloudinary$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["v2"].uploader.upload(file, {
...
const uploadBuffer = async (buffer, filename, options = {})=>{
    try {
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cloudinary$2f$cloudinary$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["v2"].uploader.upload_stream({
            folder: options.folder || 'ikazeproperty',
            resource_type: options.resource_type || 'auto',
            transformation: options.transformation,
            overwrite: false,
...
const deleteImage = async (public_id)=>{
    try {
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cloudinary$2f$cloudinary$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["v2"].uploader.destroy(public_id);
        return result;
    } catch (error) {
...
const generateUploadSignature = (options = {})=>{
    ...
    const signature = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cloudinary$2f$cloudinary$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["v2"].utils.api_sign_request(params, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.CLOUDINARY_API_SECRET);
    return {
        signature,
        timestamp,
        cloud_name: ("TURBOPACK compile-time value", "dp7yzc36n"),
...
const getOptimizedImageUrl = (public_id, options = {})=>{
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cloudinary$2f$cloudinary$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["v2"].url(public_id, {
        transformation,
        secure: true
    });
};
...
const getListingImages = (public_id)=>{
    return {
        ...
        original: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cloudinary$2f$cloudinary$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["v2"].url(public_id, {
            secure: true
        })
    };
};
            ...
            try {
                const uploadPromises = files.map({
                    "ImageUpload.useCallback[handleFileSelect].uploadPromises": async (file)=>{
                        // Validate file
                        const validation = file.type.startsWith('image/') ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cloudinary$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["validateImage"])(file) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cloudinary$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["validateVideo"])(file);
                        if (!validation.valid) {
...
//# sourceMappingURL=src_98340ff5._.js.map