...
"[project]/src/lib/file-validation.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$file$2d$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/file-validation.ts [app-client] (ecmascript)");
;
...
function ImageUpload({ images, onImagesChange, maxImages = 20, acceptVideos = false, className = '' }) {
    ...
    const handleFileSelect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ImageUpload.useCallback[handleFileSelect]": async (event)=>{
            ...
            try {
                const uploadPromises = files.map({
                    "ImageUpload.useCallback[handleFileSelect].uploadPromises": async (file)=>{
                        // Validate file
                        const validation = file.type.startsWith('image/') ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$file$2d$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["validateImage"])(file) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$file$2d$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["validateVideo"])(file);
                        if (!validation.valid) {
                ...
                }["ImageUpload.useCallback[handleFileSelect].uploadPromises"]);
    ...
    const handleRemoveImage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ImageUpload.useCallback[handleRemoveImage]": async (public_id)=>{
            try {
                ...
                // Remove from state
                onImagesChange(images.filter({
                    "ImageUpload.useCallback[handleRemoveImage]": (img)=>img.public_id !== public_id
                        ...
                        children: images.map((image, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: image.type === 'video' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(ImageUpload, "HcbyuCwcpcnHGpOx4fuBd9+rQ/k=");
_c = ImageUpload;
var _c;
...
_s(CreateListingPage, "08BnSuBEtaGgUadEdOaJHvVY9+U=", false, function() {
    return [
...
//# sourceMappingURL=src_b8922013._.js.map