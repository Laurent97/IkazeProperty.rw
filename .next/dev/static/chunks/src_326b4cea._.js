...
function LikesDisplay({ listingId, likesCount, className = '' }) {
    ...
    const fetchLikedUsers = async ()=>{
        ...
        setLoading(true);
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('favorite_listings').select(`
          user_id,
...
//# sourceMappingURL=src_326b4cea._.js.map