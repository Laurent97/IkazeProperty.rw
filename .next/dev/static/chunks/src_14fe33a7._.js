...
function AdminSettingsPage() {
    ...
    const handleSaveSettings = async (section)=>{
        try {
            setSaving(true);
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('settings').upsert({
                id: 1,
                ...settings,
