...
"[project]/src/app/[locale]/dashboard/admin/users/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdminUsersPage() {
    ...
    const fetchUsers = async ()=>{
        try {
            setLoading(true);
            let query = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('users').select(`
          *,
          listings(count)
        `, {
                count: 'exact'
    ...
    const handleSuspendUser = async (userId, currentStatus)=>{
        ...
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('users').update({
                status: newStatus
            }).eq('id', userId);
            if (error) throw error;
            // Refresh users
    ...
    const handleDeleteUser = async (userId)=>{
        ...
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('users').delete().eq('id', userId);
            if (error) throw error;
            // Refresh users
            fetchUsers();
        } catch (error) {
...
_s(AdminUsersPage, "B7fnu5svO8BVorw2IqLyRD2HyrU=");
_c = AdminUsersPage;
var _c;
...
//# sourceMappingURL=_c033c104._.js.map