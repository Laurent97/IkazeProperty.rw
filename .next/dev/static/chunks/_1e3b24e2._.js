...
function FavoritesPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FavoritesPage.useEffect": ()=>{
            const fetchUserAndFavorites = {
                "FavoritesPage.useEffect.fetchUserAndFavorites": async ()=>{
                    try {
          ...
          `).eq('user_id', currentUser.id).order('created_at', {
                        ...
                        setFavorites(data?.map({
                            "FavoritesPage.useEffect.fetchUserAndFavorites": (fav)=>fav.listings
                        }["FavoritesPage.useEffect.fetchUserAndFavorites"]).filter(Boolean) || []);
                    } catch (error) {
            ...
            }["FavoritesPage.useEffect.fetchUserAndFavorites"];
...
//# sourceMappingURL=_1e3b24e2._.js.map