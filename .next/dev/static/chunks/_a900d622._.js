...
function AdminInquiriesPage() {
    ...
    const fetchInquiries = async ()=>{
        try {
            setLoading(true);
            let query = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('inquiries').select(`
          *,
    ...
    const handleUpdateStatus = async (inquiryId, newStatus)=>{
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('inquiries').update({
                status: newStatus
            }).eq('id', inquiryId);
            if (error) throw error;
            // Refresh inquiries
...
_s(AdminInquiriesPage, "8pGnuh0sG+HbdSPAuUHX89MVV7o=");
...
//# sourceMappingURL=_a900d622._.js.map